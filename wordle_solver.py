...
class WordleSolver():
    ...
    def __init__(self, words_list,mode = "fast",parallel_sim = True, only1_vowels = False):
        ...
        self.possible_words_to_fish = self.get_possible_words(
            {"with_position": [], "presents": [], "not_presents": []}, only1_vowels)
    ...
    def get_possible_words(self, game_state, only1_vowels = False):
        ...
        if only1_vowels:
            ...
            if len(possible_words_vocals) >0:
